...
//                Intent intent = new Intent(PayRecordActivity.this,BusinessDetailed.class);
...
//                startActivity(intent);
    ...
    private void show() {
        ...
        final BmobQuery<PayRecord> businessBmobQuery = new BmobQuery<>();
        businessBmobQuery.findObjects(new FindListener<PayRecord>() {
            @Override
            public void done(List<PayRecord> list, BmobException e) {
                if (e == null) {
                    for (PayRecord business : list) {
